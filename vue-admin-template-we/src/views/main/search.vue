    ...
    <div class="row">
      <div class="span10">
        <div class="slate clearfix">
          <a class="stat-column">
            <span class="number">30{{ organizationList.length }}</span>
            <span>总爬取高校数</span>
          </a>
          <a class="stat-column">
            <span class="number">10{{ total }}</span>
            <span>总爬取学者数</span>
          </a>
        </div>
      </div>
    ...
    <el-card class="card2">
      ...
      <div style="margin-bottom: 20px">
        <el-row class="search">
          ...
          <el-col :span="4">
            <el-button type="primary" style="border-radius: 10px;background-color: #38b580;border-color: #38b580"
                       icon="el-icon-search" @click="searchCollegeCount">搜索
            </el-button>
          </el-col>
  ...
  methods: {
    ...
    drawBar() {
      var chart = Highcharts.chart('Bar', {
        ...
        title: {
          text: this.organizationValue + '学者论文数量Top10'
        },
        subtitle: {
    ...
    drawBar1() {
      var chart = Highcharts.chart('Bar1', {
        ...
        title: {
          text: this.organizationValue + '学者项目数量Top10'
        },
        subtitle: {
          text: '数据截止 2017-03，来源: <a href="https://en.wikipedia.org/wiki/List_of_cities_proper_by_population">Wikipedia</a>'
        },
        ...
        tooltip: {
          pointFormat: '项目数量: <b>{point.y:.1f} 篇</b>'
        },
        series: [{
          name: '项目数量',
          data: [
